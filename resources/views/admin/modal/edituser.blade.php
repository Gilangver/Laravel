<div class="modal fade" id="editPelanggan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <form action="{{ route('updateuser', $data->id) }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        <label for="prov" class="col-sm-4 col-form-label">prov</label>
                        <div class="col-sm-8">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" type="text" style="width: 300px; height:40px;"
                                ...
                                <option value="Kota Madya" {{ $data->kab =='Kota Madya'?'selected':'' }}>Kota Madya</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" type="text" style="width: 300px; height:40px;"
                                ...
                                <option value="Ngaglik" {{ $data->kec ==='Ngaglik'?'selected':'' }}>Ngaglik</option>
                                <option value="Gamping" {{ $data->kec ==='Gamping'?'selected':'' }}>Gamping</option>
                                <option value="Depok" {{ $data->kec ==='Depok'?'selected':'' }}>Depok</option>
                                <option value="Mlati" {{ $data->kec ==='Mlati'?'selected':'' }}>Mlati</option>
                                <option value="Gondokusuman" {{ $data->kec ==='Gondokusuman'?'selected':'' }}>Gondokusuman</option>
                                <option value="Wirobrajan" {{ $data->kec ==='Wirobrajan'?'selected':'' }}>Wirobrajan</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="detail" name="detail" placeholder="Detail Alamat" value="{{ $data->detail }}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="role" class="col-sm-4 col-form-label">Role</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="role" name="role" placeholder="Role" value="{{ $data->role }}">
                        </div>
                    </div>
