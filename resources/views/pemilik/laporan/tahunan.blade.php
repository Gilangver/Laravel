...
<div class="card border-0 mt-4 atas">
    <div class="d-flex justify-content-between">
        ...
        <div class="mt-4  me-5 text-end">
            <label for="tanggal">Masukkan Tahun:</label>
            <input class="border-1 ms-2" style="width:100px; height:38px; border-radius:10px;" type="number" id="tahun" name="tahun" min="2020" max="2100">
            <button class="btn btn-warning fw-bold text-white rounded-3 ms-2 me-3">
                Tampilkan
            </button>
        </div>
    </div>
