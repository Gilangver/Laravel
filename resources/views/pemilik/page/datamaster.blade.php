...
@section('home')
    <br><br><br>
    <div class="container mt-3 atas">
        <h3 class="text-center fw-bold">Data Admin</h3>
        <div class=" card border-0 container d-flex position-relative mb-2">
            <div class="mb-2 mt-2">
            ...
            <div class="position-absolute bottom-0 end-0 mb-2 mt-2 me-3">
                <form action="/datamaster" class="d-flex" role="search">
                    ...
                    @foreach ($data as $y => $x)
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-danger deleteuser" data-id="{{ $x->id }}" data-nama="{{ $x->nama_barang }}">
