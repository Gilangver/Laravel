...
@section('home')
    <div class="container py-5 mt-5">
        <div class="row">
            ...
            <div class=" col-lg-8">
                <div class=" card shadow border rounded text-center  mb-3">
        ...
        <div class="tampileditdatapelanggan" style="display: none;"></div>
        ...
        <script>
            ...
            $('.edit-profil').click(function(e) {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('editprofil', ['id' => ':id']) }}".replace(':id', id),
                    success: function(response) {
                        $('.tampileditdatapelanggan').html(response).show();
